...
import jaygoo.widget.dbv.utils.GeometryUtils;
...
public class DragBadgeView extends View {
    protected static final String TAG = "DragBadgeView";
    ...
    public DragBadgeView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public DragBadgeView(Context context, int color) {
        this(context, null);
        mColor = color == 0 ? Color.RED : color;
    }
